...
public class Service_BTLE_GATT extends Service {
    ...
    private BTLEServicesActivity ble;
    ...
    /*
    public final static UUID BMS_Characteristics = UUID.fromString("ed0ef62e-9b0d-11e4-89d3-123b93f75cba");
    public final static UUID SOC = UUID.fromString("ed0eabcd-9b0d-11e4-89d3-123b93f75cba");
     */
...
//        }
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        // in case you need to send data for its use somewhere when characteristic value changes
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled) {
        ...
        /*
        if(characteristic.getUuid().toString().matches("ed0ef62e-9b0d-11e4-89d3-123b93f75dba")){
